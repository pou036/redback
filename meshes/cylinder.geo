...
Point(1) = {0,0,-height/2.,lc}; // center of the base

Point(2) = {radius,0,-height/2.,lc};
Point(3) = {0,radius,-height/2.,lc};
Point(4) = {-radius,0,-height/2.,lc};
Point(5) = {0,-radius,-height/2.,lc};
