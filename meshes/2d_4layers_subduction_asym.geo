...
ymin = -6;
ybase = -5;
y1a = -0.05; //-0.05; // bottom of middle layer, LHS
y2a = 0.05;  //0.05; // top of middle layer, LHS
y1b = -0.05; //-0.05; // bottom of middle layer, RHS
y2b = 0.05;  //0.05; // top of middle layer, RHS
ymax = 5;
/****** MESH ***********/
...
Point(3) = {xmax, y1b, 0, lc2};
Point(4) = {xmin, y1a, 0, lc2};
Point(5) = {xmax, y2b, 0, lc2};
Point(6) = {xmin, y2a, 0, lc2};
