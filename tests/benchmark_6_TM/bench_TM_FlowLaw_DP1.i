...
[Materials]
  [./mat_mech]
    ...
    total_porosity = 0.1
    flow_law = mydislocation
    flow_law_dislocation = mydislocation
  [../]
  [./mat_nomech]
...
[AuxVariables]
  active = 'dislocation_strain_rate_var'
  [./stress_zz]
    order = CONSTANT
    family = MONOMIAL
  [../]
...
[AuxKernels]
  active = 'dislocation_strain_rate_kernel'
  [./stress_zz]
    type = RankTwoAux
  ...
  [../]
  [./dislocation_strain_rate_kernel]
    type = MaterialRealAux
    variable = dislocation_strain_rate_var
    property = dislocation_strain_rate # property defined in C code with declareProperty
  [../]
[]

[Postprocessors]
  active = 'dis_strain_rate_centre'
  [./mises_stress]
    type = PointValue
    variable = mises_stress
    point = '0 0 0'
...
[UserObjects]
  [./mydif]
    type = RedbackFlowLawDiffusion
    temperature = temp
  [../]
  [./mydislocation]
    type = RedbackFlowLawDislocation
    Arrhenius = 10
    temperature = temp
  [../]
[]
...
[Outputs]
  file_base = bench_TM_FlowLaw_DP1_out
  output_initial = true
  #exodus = true
  csv = true
  [./console]
