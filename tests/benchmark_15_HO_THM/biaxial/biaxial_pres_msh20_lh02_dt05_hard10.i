...
[Materials]
  ...
  [./Redbackcosserat]
    ...
    block = 0
    B_ijkl = '0.0 9.248E2  9.248E2'
    C_ijkl = '3.6E2 4.0E1 2.0E1'
    fill_method = general_isotropic
    poisson_ratio = -9999
    youngs_modulus = -9999
...
[Preconditioning]
  ...
  [./andy]
    ...
    petsc_options_value = 'gmres          bjacobi     1E-6           1E-8          30                1E-10     1E-12 '
  [../]
  [./debug_jacob]
    type = FDP
    full = true
...
[Outputs]
  ...
  exodus = true
  file_base = biaxial_pres_msh20_lh02_dt01_hard1
