...
[BCs]
  ...
  active = 'Periodic uy_bottom ux_ramp_top wcx_equals_zero_on_top ux_zero_bottom wcy_equals_zero_on_top wc_x_bottom uz_bottom wc_y_bottom confining_pres'
...
[Outputs]
  ...
  exodus = true
  file_base = plastic_shear_R25_Hs400_sig_THM
