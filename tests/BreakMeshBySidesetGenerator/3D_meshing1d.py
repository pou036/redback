''' rectangle faults intersecting amd touching bounding box  '''
...
def generate3DMesh(mesh_filename='out.msh', params={}, do_show=False):
  ...
  tag_rect1 = factory.addRectangle(0., 0., 0.5, 1, 1, -1, 0) # x, y, z, dx, dy, tag=-1, roundedRadius=0.
  tag_rect2 = factory.addRectangle(0., 0., 0.5, 1, 1, -1, 0) # x, y, z, dx, dy, tag=-1, roundedRadius=0.
  ...
  # Add physical tags
  model.addPhysicalGroup(2, [11,15], 1) # (dim, tags, tag)
  model.setPhysicalName(2, 1, 'left') # (dim, tag, name)
  model.addPhysicalGroup(2, [21,24], 2)
  model.setPhysicalName(2, 2, 'right')
  model.addPhysicalGroup(2, [17,26], 3)
  model.setPhysicalName(2, 3, 'front')
  model.addPhysicalGroup(2, [14,20], 4)
  model.setPhysicalName(2, 4, 'back')
  model.addPhysicalGroup(2, [12,16,19,25], 5)
  model.setPhysicalName(2, 5, 'bottom')
  model.addPhysicalGroup(2, [13,18,22,23], 6)
...
if __name__ == "__main__":
  ...
  generate3DMesh(mesh_filename='3Dcase1d.msh', params=params, do_show=True)
  print 'Finished'
