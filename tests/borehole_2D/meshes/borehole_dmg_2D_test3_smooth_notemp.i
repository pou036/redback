[Mesh]
  type = FileMesh
  file = Cylinder_hollow_perturb_fine_2D_square_mesh.msh
...
[Functions]
  ...
  [./timestep_function]
    ...
    type = ParsedFunction
    value = 1e-4 # if(t>0.0169, 1e-7, if(t>0.0168, 2e-6,1e-4))
  [../]
[]
...
[Outputs]
  ...
  file_base = borehole_dmg_2D_test3_smooth_test2_notemp2
[]
