...
[Functions]
  ...
  [./timestep_function]
    ...
    type = ParsedFunction
    value = 'if(t>0.0285, 2e-5, 5e-4)' # if(t>0.0169, 1e-7, if(t>0.0168, 2e-6,1e-4))
  [../]
  [./outer_pressure_fct]
    type = ParsedFunction
    value = 1e-3
...
[Postprocessors]
  active = 'disp_inner_x disp_inner_y nnli max_r_theta new_timestep nli old_timestep'
  [./max_temp]
    type = NodalMaxValue
    variable = temperature
  [../]
...
[Outputs]
  ...
  file_base = cylinder_thinner_timestep1
[]
