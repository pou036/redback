[Mesh]
  type = FileMesh
  file = Cnoidal_Cylinder_thin_quarter_perturb_test24.msh
...
[Functions]
  ...
  [./timestep_function]
    ...
    type = ParsedFunction
    value = 'if(t<0.07, 2e-3, 5e-4)' # if(t>0.0169, 1e-7, if(t>0.0168, 2e-6,1e-4))
  [../]
  [./outer_pressure_fct]
    type = ParsedFunction
    value = 1e-3
...
[Outputs]
  ...
  file_base = Cnoidal_Cylinder_2D_quarter_test1_24
  interval = 5
[]
