...
Transfinite Line {1,2,3,4} = Ceil(nb_rings*1.5+1);
Transfinite Line {5,9} = Ceil(nb_slices_quarter*1.5+1) Using Progression 1;
...
Transfinite Line {21,22,23,24} = Ceil(nb_slices_quarter*1.5+1) Using Progression 1;
