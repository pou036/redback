...
[Materials]
  [./mat_mech]
    ...
    eptol = 1e-7
    ref_pe_rate = 100
    chemo_mechanical_porosity_coeff = 1e-3 # 3e8
...
[BCs]
  active = 'Pressure hole_rotat_x hole_rotat_y confine_x confine_y'
  [./confine_x]
    type = PresetBC
    variable = disp_x
    boundary = '101 102'
...
[AuxKernels]
  active = 'mech_porosity volumetric_strain mises_strain_rate stress_yy stress_xx stress_xy mises_stress mass_removal_rate total_porosity eqv_plastic_strain plastic_strain_r_theta stress_r_theta strain_theta_theta strain_r_r'
  [./total_porosity]
...
[Outputs]
  ...
  [../]
  [./manman]
    file_base = Anisotropic_borehole_chem4
    type = Exodus
  [../]
[]
