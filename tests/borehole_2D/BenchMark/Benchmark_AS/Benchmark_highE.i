...
[Postprocessors]
  active = 'Num_elements disp_hole_x avg_dissip max_r_theta new_timestep old_timestep stress_rr_a stress_theta_a'
  [./max_temp]
    type = NodalMaxValue
    variable = temperature
  [../]
...
[Outputs]
  ...
  file_base = Benchmark_highE_test
  [./myexodus]
    file_base = test_THOMAS
    type = Exodus
