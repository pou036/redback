[Mesh]
  type = FileMesh
  file = ../meshes/Cylinder_quarter_purturb_coarse.msh
...
[Functions]
  ...
  [./timestep_function]
    ...
    # 1e-3
    type = ParsedFunction
    value = 'if (t<0.13,1e-3,  dt*max(0.2, 1-0.1*(n-30)))' # if(t>0.0169, 1e-7, if(t>0.0168, 2e-6,1e-4))
...
[Outputs]
  ...
  file_base = Cylinder_quarter_perturb_coarse
  interval = 10
[]
