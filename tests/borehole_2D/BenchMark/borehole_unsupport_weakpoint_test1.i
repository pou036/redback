[Mesh]
  type = FileMesh
  file = ../meshes/Cylinder_hollow_perturb_fine_2D_square_mesh_quarter2.msh
...
[Functions]
  ...
  [./timestep_function]
    # 5*1e-4
    type = ParsedFunction
    value = 'if(t>0.0225, 5e-5, 5e-4)' # if(t>0.0169, 1e-7, if(t>0.0168, 2e-6,1e-4))
  [../]
  [./outer_pressure_fct]
    type = ParsedFunction
    value = 2e-3*5 # 1e-3
...
[Materials]
  active = 'no_mech plastic_material plastic_material1'
  [./no_mech]
...
[Outputs]
  ...
  file_base = borehole_unsupport_test1
[]
