[Mesh]
  type = FileMesh
  file = Cylinder_hollow_perturb_fine_2D_square_mesh_quarter.msh
...
[AuxVariables]
  active = 'strain_theta_theta strain_r_theta strain_r_r'
  [./strain_r_r]
    order = CONSTANT
    family = MONOMIAL
  [../]
...
[Functions]
  ...
  [./inner_pressure_fct]
    type = ParsedFunction
    value = (1e-3+4e-2*t)*0 # 1e-3+4e-2*t
  [../]
  [./timestep_function]
    ...
    type = ParsedFunction
    value = (5*1e-4)*1e3 # if(t>0.0169, 1e-7, if(t>0.0168, 2e-6,1e-4))
  [../]
  [./outer_pressure_fct]
    type = ParsedFunction
    value = 2e5 # 1e-3
...
[AuxKernels]
  active = 'plastic_strain_r_r strain_theta_theta strain_r_theta'
  [./plastic_strain_r_r]
...
[Materials]
  ...
  [./plastic_material]
    ...
    outputs = all
    pore_pres = porepressure
    yield_stress = '0 0.006 1 0.006' # 0 0.006 1 0.006
    poisson_ratio = 0.25
    youngs_modulus = 100
    damage = damage
...
[Outputs]
  ...
  file_base = borehole_dmg_2D_test3_notemp_quarter_test1
[]
