[Mesh]
  type = FileMesh
  file = ../meshes/Cylinder_hollow_perturb_fine_2D_square_mesh_quarter_denserr.msh
...
[Postprocessors]
  active = 'nnli max_r_theta new_timestep nli old_timestep disp_hole'
  [./max_temp]
    type = NodalMaxValue
    variable = temperature
  [../]
...
[Outputs]
  ...
  file_base = borehole_pushinside_benchmark_test12
[]
