[Mesh]
  type = FileMesh
  file = ../meshes/Cylinder_quarter_purturb_fine.msh
...
[Functions]
  ...
  [./timestep_function]
    ...
    type = ParsedFunction
    value = 'if(t>0.15, 1e-4, 1e-3)' # if(t>0.0169, 1e-7, if(t>0.0168, 2e-6,1e-4))
  [../]
  [./outer_pressure_fct]
    type = ParsedFunction
    value = 0 # 1e-3
...
[Outputs]
  ...
  file_base = Cylinder_quarter_perturb_fine_slow1
[]
