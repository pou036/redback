...
[Postprocessors]
  active = 'tangential_force Rotation_wcz_0_9 antisymmetric_bottom disp_y_top normal_force number_nonlin disp_x_top number_lin wc_z_top antisymmetric_top'
  [./disp_y_top]
    type = PointValue
    point = '0.5 1 1'
    variable = disp_y
