...
[Kernels]
  active  = 'cx_elastic cy_elastic cz_elastic x_couple y_couple z_couple x_moment y_moment z_moment dT_dt dp_dt mech_dissip T_diff'
  [./cx_elastic]
...
[Outputs]
  ...
  exodus = true
  file_base = shear_R10_mesh160_TM
