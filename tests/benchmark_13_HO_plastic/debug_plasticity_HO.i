...
[Postprocessors]
  active = 'tangential_force number_nonlin number_lin dt'
  [./disp_y_top]
    type = PointValue
...
[BCs]
  ...
  active = 'Periodic wcy_equals_zero_on_top wc_x_bottom ux_zero_top wcz_imposed_top ux_shear_bottom wcx_equals_zero_on_top confining_pres uz_bottom wc_z_bottom_zero uy_bottom wc_y_bottom'
...
[Preconditioning]
  ...
  [./andy]
    ...
    petsc_options_value = 'gmres          bjacobi     1E-10          1E-8          10                1E-12      1E-10 '
    line_search = basic
  [../]
  [./debug_jacob]
    type = FDP
