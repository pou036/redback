[Mesh]
  type = FileMesh
  file = fault_mesh2.msh
  boundary_name = 'top left front bottom right back'
...
[Materials]
  active = 'Redbackcosserat redback_mat cosserat_default'
  [./cosserat]
  ...
  [./Redbackcosserat]
    ...
    hardening_mech_modulus = -0.00667
...
[Preconditioning]
  ...
  [./andy]
    ...
    petsc_options_value = 'gmres          bjacobi     1E-7          1E-6          30                1E-12      1E-10 '
    line_search = basic
  [../]
  [./debug_jacob]
    type = FDP
...
[Outputs]
  ...
  exodus = true
  file_base = plastic_mech_default
