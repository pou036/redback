...
[Postprocessors]
  active = 'number_lin disp_y_top tangential_force normal_force number_nonlin disp_x_bottom wc_z_top dt'
  [./disp_y_top]
    type = PointValue
...
[AuxVariables]
  active = 'elastic_curvature_32 couple_stress_23 epsilon_22 stress_11 stress_12 elastic_curvature_23 macro_rot epsilon_11 couple_stress_32 stress_22'
  [./stress_22]
    order = CONSTANT
    family = MONOMIAL
  [../]
...
[AuxKernels]
  active = 'stress_11 stress_12 elastic_curvature_32 elastic_curvature_23 antisymmetric_strain epsilon_11 couple_stress_32 stress_22 couple_stress_23 epsilon_22'
  [./stress_22]
    type = RankTwoAux
    variable = stress_22
...
[Outputs]
  ...
  exodus = true
  file_base = plastic_mech_elast_w0
