...
[Postprocessors]
  active = 'tangential_force antisymmetric_bottom disp_y_top normal_force number_nonlin disp_x_top number_lin wc_z_top antisymmetric_top'
  [./disp_y_top]
    type = PointValue
    point = '40 40 40'
    variable = disp_y
...
[BCs]
  ...
  active = 'Periodic wcy_equals_zero_on_top wc_x_bottom ux_shear_top Rotation_wc_z_bottom ux_zero_bottom ux_shear_bottom wcx_equals_zero_on_top confining_pres uz_bottom uy_bottom wc_y_bottom rotation_wcz_top'
...
[Materials]
  ...
  [./Redbackcosserat]
    ...
    block = 0
    B_ijkl = '0 88.4956 88.4956'
    C_ijkl = '15.5465 44.2478 22.1239'
    fill_method = general_isotropic
    poisson_ratio = -9999
    youngs_modulus = -9999
