...
[Postprocessors]
  active  = 'number_lin disp_y_top tangential_force normal_force number_nonlin disp_x_bottom wc_z_top dt disp_x_0 disp_x_1 disp_x_2 disp_x_3 disp_x_4 disp_x_5 disp_x_6 disp_x_7 disp_x_8 disp_x_9 disp_x_10 disp_x_11 disp_x_12 disp_x_13 disp_x_14 disp_x_15 disp_x_16 disp_x_17 disp_x_18 disp_x_19 disp_x_20 disp_x_21 disp_x_22 disp_x_23 disp_x_24 disp_x_25 disp_x_26 disp_x_27 disp_x_28 disp_x_29 disp_x_30 disp_x_31 disp_x_32 wc_z_0 wc_z_1 wc_z_2 wc_z_3 wc_z_4 wc_z_5 wc_z_6 wc_z_7 wc_z_8 wc_z_9 wc_z_10 wc_z_11 wc_z_12 wc_z_13 wc_z_14 wc_z_15 wc_z_16 wc_z_17 wc_z_18 wc_z_19 wc_z_20 wc_z_21 wc_z_22 wc_z_23 wc_z_24 wc_z_25 wc_z_26 wc_z_27 wc_z_28 wc_z_29 wc_z_30 wc_z_31 wc_z_32 strain_xy_0 strain_xy_1 strain_xy_2 strain_xy_3 strain_xy_4 strain_xy_5 strain_xy_6 strain_xy_7 strain_xy_8 strain_xy_9 strain_xy_10 strain_xy_11 strain_xy_12 strain_xy_13 strain_xy_14 strain_xy_15 strain_xy_16 strain_xy_17 strain_xy_18 strain_xy_19 strain_xy_20 strain_xy_21 strain_xy_22 strain_xy_23 strain_xy_24 strain_xy_25 strain_xy_26 strain_xy_27 strain_xy_28 strain_xy_29 strain_xy_30 strain_xy_31 lagrange_0 lagrange_1 lagrange_2 lagrange_3 lagrange_4 lagrange_5 lagrange_6 lagrange_7 lagrange_8 lagrange_9 lagrange_10 lagrange_11 lagrange_12 lagrange_13 lagrange_14 lagrange_15 lagrange_16 lagrange_17 lagrange_18 lagrange_19 lagrange_20 lagrange_21 lagrange_22 lagrange_23 lagrange_24 lagrange_25 lagrange_26 lagrange_27 lagrange_28 lagrange_29 lagrange_30 lagrange_31'
  [./wc_z_0]
    type = PointValue
    point = '0.0 0.0 0.0'
    variable = wc_z
  ...
  [./lagrange_3]
    type = PointValue
    point = '0.0 6.5625 0.0'
    variable = lagrange
  [../]
  [./lagrange_4]
    type = PointValue
    point = '0.0 8.4375 0.0'
    variable = lagrange
  [../]
  [./lagrange_5]
    type = PointValue
    point = '0.0 10.3125 0.0'
    variable = lagrange
  [../]
  [./lagrange_6]
    type = PointValue
    point = '0.0 12.1875 0.0'
    variable = lagrange
  [../]
  [./lagrange_7]
    type = PointValue
    point = '0.0 14.0625 0.0'
    variable = lagrange
  [../]
  [./lagrange_8]
    type = PointValue
    point = '0.0 15.9375 0.0'
    variable = lagrange
  [../]
  [./lagrange_9]
    type = PointValue
    point = '0.0 17.8125 0.0'
    variable = lagrange
  [../]
  [./lagrange_10]
    type = PointValue
    point = '0.0 19.6875 0.0'
    variable = lagrange
  [../]
  [./lagrange_11]
    type = PointValue
    point = '0.0 21.5625 0.0'
    variable = lagrange
  [../]
  [./lagrange_12]
    type = PointValue
    point = '0.0 23.4375 0.0'
    variable = lagrange
  [../]
  [./lagrange_13]
    type = PointValue
    point = '0.0 25.3125 0.0'
    variable = lagrange
  [../]
  [./lagrange_14]
    type = PointValue
    point = '0.0 27.1875 0.0'
    variable = lagrange
  [../]
  [./lagrange_15]
    type = PointValue
    point = '0.0 29.0625 0.0'
    variable = lagrange
  [../]
  [./lagrange_16]
    type = PointValue
    point = '0.0 30.9375 0.0'
    variable = lagrange
  [../]
  [./lagrange_17]
    type = PointValue
    point = '0.0 32.8125 0.0'
    variable = lagrange
  [../]
  [./lagrange_18]
    type = PointValue
    point = '0.0 34.6875 0.0'
    variable = lagrange
  [../]
  [./lagrange_19]
    type = PointValue
    point = '0.0 36.5625 0.0'
    variable = lagrange
  [../]
  [./lagrange_20]
    type = PointValue
    point = '0.0 38.4375 0.0'
    variable = lagrange
  [../]
  [./lagrange_21]
    type = PointValue
    point = '0.0 40.3125 0.0'
    variable = lagrange
  [../]
  [./lagrange_22]
    type = PointValue
    point = '0.0 42.1875 0.0'
    variable = lagrange
  [../]
  [./lagrange_23]
    type = PointValue
    point = '0.0 44.0625 0.0'
    variable = lagrange
  [../]
  [./lagrange_24]
    type = PointValue
    point = '0.0 45.9375 0.0'
    variable = lagrange
  [../]
  [./lagrange_25]
    type = PointValue
    point = '0.0 47.8125 0.0'
    variable = lagrange
  [../]
  [./lagrange_26]
    type = PointValue
    point = '0.0 49.6875 0.0'
    variable = lagrange
  [../]
  [./lagrange_27]
    type = PointValue
    point = '0.0 51.5625 0.0'
    variable = lagrange
  [../]
  [./lagrange_28]
    type = PointValue
    point = '0.0 53.4375 0.0'
    variable = lagrange
  [../]
  [./lagrange_29]
    type = PointValue
    point = '0.0 55.3125 0.0'
    variable = lagrange
  [../]
  [./lagrange_30]
    type = PointValue
    point = '0.0 57.1875 0.0'
    variable = lagrange
  [../]
  [./lagrange_31]
    type = PointValue
    point = '0.0 59.0625 0.0'
    variable = lagrange
  [../]
  [./strain_xy_0]
    type = PointValue
...
[Preconditioning]
  ...
  [./andy]
    ...
    petsc_options_value = 'gmres          bjacobi     1E-6          1E-7          50             1E-12      1E-10 '
    line_search = basic
  [../]
  [./debug_jacob]
    type = FDP
...
[Outputs]
  ...
  exodus = true
  file_base = plastic_shear_mesh32DB
