...
[BCs]
  ...
  active = 'Periodic uy_bottom ux_ramp_top uy_ramp_top wcx_equals_zero_on_top ux_zero_bottom wcy_equals_zero_on_top wc_x_bottom uz_bottom wc_y_bottom'
...
[Outputs]
  ...
  exodus = true
  file_base = shear_R10_mesh160_homo
