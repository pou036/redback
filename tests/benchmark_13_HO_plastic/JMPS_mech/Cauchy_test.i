...
[Postprocessors]
  active  = 'number_nonlin number_lin disp_y_top tangential_force normal_force number_nonlin disp_x_top wc_z_top dt'
  [./disp_y_top]
...
[Materials]
  ...
  [./Redbackcosserat]
    ...
    block = '0'
    B_ijkl = '0 2.0E4 2.0E4'
    C_ijkl = '1.3333E4 1.0E4 0.001'
    fill_method = general_isotropic
    poisson_ratio = -9999
    youngs_modulus = -9999
...
[Preconditioning]
  ...
  [./andy]
    ...
    petsc_options_value = 'gmres          bjacobi     1E-5        1E-8      30      1E-12      1E-10 '
    line_search = basic
  [../]
  [./debug_jacob]
    type = FDP
