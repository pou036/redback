...
[Postprocessors]
  active = 'number_lin disp_y_top tangential_force normal_force number_nonlin disp_x_bottom wc_z_top dt timestep'
  [./disp_y_top]
    type = PointValue
    point = '60 60 60'
    variable = disp_y
...
[Functions]
  active = 'ramp_neg ramp timestep_func'
  [./ramp]
    # -0.0005*t
    type = ParsedFunction
    value = 0.1*t
