...
[Materials]
  ...
  [./Redbackcosserat]
    ...
    block = 0
    B_ijkl = '1 5.0E4 5.0E4'
    C_ijkl = '1.3333E3 4.0E3 0'
    fill_method = general_isotropic
    poisson_ratio = -9999
    youngs_modulus = -9999
...
[Preconditioning]
  ...
  [./andy]
    ...
    petsc_options_value = 'gmres      bjacobi     1E-8          1E-7          50               1E-12      1E-10 '
    line_search = basic
  [../]
  [./debug_jacob]
    type = FDP
...
[Outputs]
  ...
  exodus = true
  file_base = plastic_shear_cauchy_msh2
[]
