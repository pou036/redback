...
[Postprocessors]
  active = 'number_lin disp_y_top strain_12_top disp_x_top tangential_force normal_force strain_12_pl number_nonlin pressure_top wc_z_top dt'
  [./disp_y_top]
...
[Variables]
  active = 'pore_pressure disp_z disp_y disp_x wc_z wc_y wc_x'
  [./disp_x]
  [../]
  [./disp_y]
  [../]
...
[Kernels]
  active = 'x_couple cz_elastic cy_elastic cx_elastic poromech y_moment z_couple x_moment y_couple z_moment dp_dt P_diff'
  [./cx_elastic]
...
[BCs]
  ...
  [./Periodic]
    [./x_direction]
      variable = 'disp_x disp_y disp_z wc_x wc_y wc_z  pore_pressure'
      auto_direction = x
    [../]
    [./z_direction]
      variable = 'disp_x disp_y disp_z wc_x wc_y wc_z  pore_pressure'
...
[Outputs]
  ...
  exodus = true
  file_base = shear_R10_mesh160_HM_jac
