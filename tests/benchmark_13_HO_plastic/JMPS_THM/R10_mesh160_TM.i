...
[Postprocessors]
  active = 'number_lin disp_y_top strain_12_top disp_x_top tangential_force normal_force strain_12_pl number_nonlin wc_z_top dt Temperature_top'
  [./disp_y_top]
...
[Variables]
  active = 'disp_z disp_y disp_x wc_z wc_y wc_x temperature'
  [./disp_x]
  [../]
  [./disp_y]
  [../]
...
[Kernels]
  active = 'T_diff mech_dissip x_couple cz_elastic cy_elastic cx_elastic y_moment z_couple dT_dt x_moment y_couple z_moment'
  [./cx_elastic]
...
[BCs]
  ...
  [./Periodic]
    [./x_direction]
      variable = 'disp_x disp_y disp_z wc_x wc_y wc_z temperature '
      auto_direction = x
    [../]
    [./z_direction]
      variable = 'disp_x disp_y disp_z wc_x wc_y wc_z temperature'
...
[Outputs]
  ...
  exodus = true
  file_base = shear_R10_mesh160_TM_jac
