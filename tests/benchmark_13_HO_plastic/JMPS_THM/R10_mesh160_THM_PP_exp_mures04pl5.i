...
[Functions]
  ...
  [./ramp]
    type = ParsedFunction
    value = if(t>0.0002,1000*(t-0.0002),0)
  [../]
  [./ramp2]
    type = ParsedFunction
    value = -133*(1-exp(-t/0.005))
  [../]
  [./perturb]
    type = ParsedFunction
...
[Materials]
  ...
  [./Redbackcosserat]
    ...
    cohesion = 0.01
    hardening_mech_modulus = 0.11111
    friction_coefficient = 0.45
    min_stepsize = 1e-8
    beta_star = 8.19672E-5
...
[Outputs]
  ...
  exodus = true
  file_base = shear_R10_mesh160_THM_PP_mures045pl10_test
