...
[Postprocessors]
  active = 'disp_x_16 disp_x_17 disp_x_14 disp_x_15 disp_x_12 disp_x_13 disp_x_10 disp_x_11 disp_x_18 disp_x_19 disp_x_29 disp_x_28 disp_y_top disp_x_23 disp_x_22 disp_x_21 disp_x_20 disp_x_27 disp_x_26 disp_x_25 disp_x_24 normal_force number_nonlin dt lagrange_22 lagrange_27 lagrange_26 lagrange_25 lagrange_24 lagrange_23 number_lin lagrange_21 lagrange_20 lagrange_29 lagrange_28 lagrange_8 lagrange_9 lagrange_4 lagrange_5 lagrange_6 lagrange_7 lagrange_0 lagrange_1 lagrange_2 lagrange_3 disp_x_38 disp_x_39 disp_x_34 disp_x_35 disp_x_36 disp_x_37 disp_x_30 disp_x_31 disp_x_32 disp_x_33 lagrange_34 lagrange_35 lagrange_36 lagrange_37 lagrange_30 lagrange_31 lagrange_32 lagrange_33 lagrange_38 lagrange_39 disp_x_40 lagrange_18 lagrange_19 lagrange_16 lagrange_17 lagrange_14 lagrange_15 lagrange_12 lagrange_13 lagrange_10 lagrange_11 wc_z_top tangential_force disp_x_8 disp_x_9 disp_x_4 disp_x_5 disp_x_6 disp_x_7 disp_x_0 disp_x_1 disp_x_2 disp_x_3 disp_x_bottom'
  [./disp_x_0]
    type = PointValue
    point = '0.1 0.0 0.1'
    variable = disp_x
  ...
  [./lagrange_0]
    type = PointValue
    point = '0.1 0.0625 0.1'
    variable = lagrange
  [../]
  [./lagrange_1]
    type = PointValue
    point = '0.1 0.1875 0.1'
    variable = lagrange
  [../]
  [./lagrange_2]
    type = PointValue
    point = '0.1 0.3125 0.1'
    variable = lagrange
  [../]
  [./lagrange_3]
    type = PointValue
    point = '0.1 0.4375 0.1'
    variable = lagrange
  [../]
  [./lagrange_4]
    type = PointValue
    point = '0.1 0.5625 0.1'
    variable = lagrange
  [../]
  [./lagrange_5]
    type = PointValue
    point = '0.1 0.6875 0.1'
    variable = lagrange
  [../]
  [./lagrange_6]
    type = PointValue
    point = '0.1 0.8125 0.1'
    variable = lagrange
  [../]
  [./lagrange_7]
    type = PointValue
    point = '0.1 0.9375 0.1'
    variable = lagrange
  [../]
  [./lagrange_8]
    type = PointValue
    point = '0.1 1.0625 0.1'
    variable = lagrange
  [../]
  [./lagrange_9]
    type = PointValue
    point = '0.1 1.1875 0.1'
    variable = lagrange
  [../]
  [./lagrange_10]
    type = PointValue
    point = '0.1 1.3125 0.1'
    variable = lagrange
  [../]
  [./lagrange_11]
    type = PointValue
    point = '0.1 1.4375 0.1'
    variable = lagrange
  [../]
  [./lagrange_12]
    type = PointValue
    point = '0.1 1.5625 0.1'
    variable = lagrange
  [../]
  [./lagrange_13]
    type = PointValue
    point = '0.1 1.6875 0.1'
    variable = lagrange
  [../]
  [./lagrange_14]
    type = PointValue
    point = '0.1 1.8125 0.1'
    variable = lagrange
  [../]
  [./lagrange_15]
    type = PointValue
    point = '0.1 1.9375 0.1'
    variable = lagrange
  [../]
  [./lagrange_16]
    type = PointValue
    point = '0.1 2.0625 0.1'
    variable = lagrange
  [../]
  [./lagrange_17]
    type = PointValue
    point = '0.1 2.1875 0.1'
    variable = lagrange
  [../]
  [./lagrange_18]
    type = PointValue
    point = '0.1 2.3125 0.1'
    variable = lagrange
  [../]
  [./lagrange_19]
    type = PointValue
    point = '0.1 2.4375 0.1'
    variable = lagrange
  [../]
  [./lagrange_20]
    type = PointValue
    point = '0.1 2.5625 0.1'
    variable = lagrange
  [../]
  [./lagrange_21]
    type = PointValue
    point = '0.1 2.6875 0.1'
    variable = lagrange
  [../]
  [./lagrange_22]
    type = PointValue
    point = '0.1 2.8125 0.1'
    variable = lagrange
  [../]
  [./lagrange_23]
    type = PointValue
    point = '0.1 2.9375 0.1'
    variable = lagrange
  [../]
  [./lagrange_24]
    type = PointValue
    point = '0.1 3.0625 0.1'
    variable = lagrange
  [../]
  [./lagrange_25]
    type = PointValue
    point = '0.1 3.1875 0.1'
    variable = lagrange
  [../]
  [./lagrange_26]
    type = PointValue
    point = '0.1 3.3125 0.1'
    variable = lagrange
  [../]
  [./lagrange_27]
    type = PointValue
    point = '0.1 3.4375 0.1'
    variable = lagrange
  [../]
  [./lagrange_28]
    type = PointValue
    point = '0.1 3.5625 0.1'
    variable = lagrange
  [../]
  [./lagrange_29]
    type = PointValue
    point = '0.1 3.6875 0.1'
    variable = lagrange
  [../]
  [./lagrange_30]
    type = PointValue
    point = '0.1 3.8125 0.1'
    variable = lagrange
  [../]
  [./lagrange_31]
    type = PointValue
    point = '0.1 3.9375 0.1'
    variable = lagrange
  [../]
  [./lagrange_32]
    type = PointValue
    point = '0.1 4.0625 0.1'
    variable = lagrange
  [../]
  [./lagrange_33]
    type = PointValue
    point = '0.1 4.1875 0.1'
    variable = lagrange
  [../]
  [./lagrange_34]
    type = PointValue
    point = '0.1 4.3125 0.1'
    variable = lagrange
  [../]
  [./lagrange_35]
    type = PointValue
    point = '0.1 4.4375 0.1'
    variable = lagrange
  [../]
  [./lagrange_36]
    type = PointValue
    point = '0.1 4.5625 0.1'
    variable = lagrange
  [../]
  [./lagrange_37]
    type = PointValue
    point = '0.1 4.6875 0.1'
    variable = lagrange
  [../]
  [./lagrange_38]
    type = PointValue
    point = '0.1 4.8125 0.1'
    variable = lagrange
  [../]
  [./lagrange_39]
    type = PointValue
    point = '0.1 4.9375 0.1'
    variable = lagrange
  [../]
  [./disp_y_top]
    type = PointValue
...
[Kernels]
  active = 'p_diff x_couple cz_elastic cy_elastic cx_elastic poromech y_moment z_couple dT_dt x_moment y_couple z_moment dp_dt'
  [./cx_elastic]
...
[Outputs]
  ...
  exodus = true
  file_base = plastic_shear_HM_h5_RI
