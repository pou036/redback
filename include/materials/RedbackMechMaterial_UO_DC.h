...
#ifndef RedbackMechMaterial_UO_DC_H
#define RedbackMechMaterial_UO_DC_H
...
class RedbackMechMaterial_UO_DC;

template <>
InputParameters validParams<RedbackMechMaterial_UO_DC>();
 ...
 */
class RedbackMechMaterial_UO_DC : public Material
{
public:
  RedbackMechMaterial_UO_DC(const InputParameters & parameters);
...
#endif // RedbackMechMaterial_UO_DC_H
