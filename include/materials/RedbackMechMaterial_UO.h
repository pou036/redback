...
#ifndef RedbackMechMaterial_UO_H
#define RedbackMechMaterial_UO_H
 ...
 */
class RedbackMechMaterial_UO : public Material
{
public:
  RedbackMechMaterial_UO(const InputParameters & parameters);
...
#endif // RedbackMechMaterial_UO_H
