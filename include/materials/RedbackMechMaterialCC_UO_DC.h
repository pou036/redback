...
#ifndef RedbackMechMaterialCC_UO_DC_H
#define RedbackMechMaterialCC_UO_DC_H

#include "RedbackMechMaterial_UO_DC.h"

// Forward Declarations
class RedbackMechMaterialCC_UO_DC;

template <>
InputParameters validParams<RedbackMechMaterialCC_UO_DC>();

class RedbackMechMaterialCC_UO_DC : public RedbackMechMaterial_UO_DC
{
public:
  RedbackMechMaterialCC_UO_DC(const InputParameters & parameters);
...
#endif // RedbackMechMaterialCC_UO_DC_H
