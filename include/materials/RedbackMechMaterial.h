...
protected:
  ...
  MaterialProperty<Real> & _dummy1;
  MaterialProperty<Real> & _dummy2;
  MaterialProperty<Real> & _dummy3;
  MaterialProperty<Real> & _dummy4;
  ...
  virtual void get_py_qy_damaged(Real, Real, Real &, Real &, Real, bool &, Real &);
