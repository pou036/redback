...
protected:
  ...
  virtual void
  computeQpStrain(const RankTwoTensor &Fhat); // from FiniteStrainMaterial.h
  ...
  virtual void returnMap(const RankTwoTensor &, const RankTwoTensor &,
                         const RankFourTensor &, RankTwoTensor &,
                         RankTwoTensor &, Real &, Real &);
  ...
  virtual void getJac(const RankTwoTensor &, const RankFourTensor &, Real, Real,
                      Real, Real, Real, Real, RankFourTensor &) = 0;
  virtual void getFlowTensor(const RankTwoTensor &, Real, Real, Real,
                             RankTwoTensor &) = 0;
