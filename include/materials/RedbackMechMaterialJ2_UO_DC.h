...
#ifndef RedbackMechMaterialJ2_UO_DC_H
#define RedbackMechMaterialJ2_UO_DC_H

#include "RedbackMechMaterial_UO_DC.h"

// Forward Declarations
class RedbackMechMaterialJ2_UO_DC;

template <>
InputParameters validParams<RedbackMechMaterialJ2_UO_DC>();

class RedbackMechMaterialJ2_UO_DC : public RedbackMechMaterial_UO_DC
{
public:
  RedbackMechMaterialJ2_UO_DC(const InputParameters & parameters);
