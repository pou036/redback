# Input file to generate the results shown on fig.5 in Sari et al 2022 (GJI)
[Mesh]
  type = FileMesh
...
[Variables]
  active = 'temp pore_pressure disp_y disp_x'
  [./disp_x]
    block = '0 1 2 3'
  [../]
  [./disp_y]
...
[Functions]
  active = 'confinement_fct bottom_ux_fct linear_temp timestep_function ramp_pos'
  [./ramp_pos]
    type = ParsedFunction
...
[BCs]
  active = 'Periodic Pressure temperature_bottom ux_bottom_vel top_cauchy_zero ux_equals_zero_on_top temperature_top uy_top pore_pressure stress_bottom'
  [./Periodic]
    active = 'xperiodic'
    [./xperiodic]
...
[AuxVariables]
  active = 'mech_porosity strain_rate stress_xx stress_xy stress_zz mises_strain_rate Mod_Gruntfest_number total_porosity mises_stress solid_ratio mises_strain Lewis_number stress_yy mean_stress volumetric_strain volumetric_strain_rate returnmap_iter'
  [./stress_zz]
    order = CONSTANT
    family = MONOMIAL
    block = 1
...
[AuxKernels]
  active = 'mech_porosity strain_rate stress_xx stress_xy stress_zz mises_strain_rate total_porosity mises_stress solid_ratio mises_strain Lewis_number stress_yy mean_stress volumetric_strain volumetric_strain_rate returnmap_iter Gruntfest_Number'
  [./stress_zz]
    type = RankTwoAux
...
[Postprocessors]
  active = 'solid_ratio_middle middle_temp_old bottom_stress_yy bottom_stress_xy mises_stress_centre max_returnmap_iter bottom_stress_xx num_li num_nli strain_rate_middle disp_fault middle_press new_timestep mean_stress_centre Lewis_middle porosity_middle dt middle_temp'
  [./middle_temp]
    type = PointValue
    variable = temp
    point = '0 0 0'
