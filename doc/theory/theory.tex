...
For now, see Word document \textcolor{blue}{REDBACK\_def\_ass\_paleowatt\_grainsize\_loop} \& \textcolor{blue}{REDBACK\_def\_grainsize\_loop} for assumtions and equation dictionary. What follows is a work flow of relevat from the 22/08/16.\\

Note: In \citet{Austin2007} Eq.10 contians error in $\kappa$ formulation, $\varepsilon_0$ is actually $K_{dis}$. See \citet{Herwegh2014} Eq.16 for the correct formulation of $\kappa$.
