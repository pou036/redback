...
\begin{multline}
  ...
  - \frac{\kappa\:\delta T_{ref}}{x^2_{ref}} \nabla^2 T - \frac{P_{ref}\:c_{th}}{x^2_{ref}} \chi \sigma^*_{ij}.\dot{\epsilon}^{*(p)}_{ij} \\
