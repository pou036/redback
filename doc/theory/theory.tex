...
\end{equation}
Also we used the infinite strain theory (O,Coussy.Poromechanics,p6-7) to calculate the strain in x,y directions,)whereas Moose Poromechanics use infinitesimal transformation theory.
\begin{equation}
...
In this problem there is a small changinging in the porosity which can be neglected .A comparison of the numerical results against the analytical solution are shown in Fig.~\ref{fig:benchmark7_with_porosity}
\begin{figure}
