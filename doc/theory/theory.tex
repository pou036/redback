...
\begin{multline}
  ...
  - \frac{V_{ref}\:\lambda\:T_{ref}}{x_{ref}}\left[\frac{(1-\phi)\lambda_s V^{*(1)}_k + \phi\lambda_f V^{*(2)}_k}{\beta_m} \right] \frac{\partial T*}{\partial x^*_k} \\
...
We then get the final mass balance formulation
