...
\section{Benchmark 3 - M}
\subsection{Comparison with Abaqus}
Most mechanical tests are performed by comparison with Abaqus. TODO: point the reader to explanations.

\subsection{Elastic 1}
\subsubsection{Problem Description}
TODO: describe the problem, mesh, boundary conditions...
\subsubsection{Results}
Figure.~\ref{fig:bench_abaqus_elastic01} show the comparison between the results obtained with Abaqus and Redback.
\begin{figure}
  \centering
  \includegraphics[width=0.48\textwidth]{figures/abaqus/bench_abaqus_elastic_01_s_mises}
  \includegraphics[width=0.48\textwidth]{figures/abaqus/bench_abaqus_elastic_01_s_pressure}
  \caption{Comparison with Abaqus results for elastic case 1.}
  \label{fig:bench_abaqus_elastic01}
\end{figure}


\subsection{Elastic 2}
\subsubsection{Problem Description}
TODO: describe the problem, just point the difference from previous case...
\subsubsection{Results}
Figure.~\ref{fig:bench_abaqus_elastic02} show the comparison between the results obtained with Abaqus and Redback.
\begin{figure}
  \centering
  \includegraphics[width=0.48\textwidth]{figures/abaqus/bench_abaqus_elastic_02_s_mises}
  \includegraphics[width=0.48\textwidth]{figures/abaqus/bench_abaqus_elastic_02_s_pressure}
  \caption{Comparison with Abaqus results for elastic case 2.}
  \label{fig:bench_abaqus_elastic02}
\end{figure}
