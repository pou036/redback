...
\chapter{Symbols}
Here is a list of (some of the) symbols used in this document.

\begin{table}
\label{tab:symbols}
\begin{tabular}{@{} l p{0.5\textwidth} l p{0.2\textwidth} @{}}
\hline\noalign{\smallskip}
Symbol & Name & Units of Measure \\
\noalign{\smallskip}\hline\noalign{\smallskip}
$Gr$ & Gruntfest number & ??? \\
...
$\bar{\Lambda}$ & Thermal pressurisation coefficient & ???  \\
$Pe$ & P\'{e}clet number & ???  \\
$\alpha$ &Solid Thermal Expansion &$\frac{10^-6}{K}$ \\
$\beta_s$ & Solid Compressibility &  $Pa^{-1}$ \\
$\phi$&Porosity& \\
$G$ & Bulk Modulus&Pa\\
$K$ & Shear Modulus& GPa\\
