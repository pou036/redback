...
by heating of an elastic rod from the back and the front ,this the rod  confined in all sides except  the top . 
...
\end{equation}
we divided $\alpha$ by $2$ because in this problem we have two dimension (area thermal expansion coefficient) for more information see this website $ (https://en.wikipedia.org/wiki/Thermal_expansion)$
...
\end{itemize}
A comparison of the numerical results against the analytical solution are shown in
\begin{figure}
