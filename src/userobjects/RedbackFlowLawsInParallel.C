...
RedbackFlowLawsInParallel::RedbackFlowLawsInParallel(const InputParameters& parameters) :
...
Real
RedbackFlowLawsInParallel::value(Real sig_eqv, Real pressure, Real q_yield_stress,
