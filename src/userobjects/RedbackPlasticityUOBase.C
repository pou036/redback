...
template <>
InputParameters
validParams<RedbackPlasticityUOBase>()
{
  InputParameters params = validParams<GeneralUserObject>();
  // params.addParam<std::string>("strength_prop_name", "Name of strength property: Same as strength user object
...
RedbackPlasticityUOBase::RedbackPlasticityUOBase(const InputParameters & parameters) : GeneralUserObject(parameters)
// ,
