...
template <>
InputParameters
validParams<RedbackMechMaterialDP_UO_DC>()
{
...
RedbackMechMaterialDP_UO_DC::RedbackMechMaterialDP_UO_DC(const InputParameters & parameters) :
 ...
 */
Real
RedbackMechMaterialDP_UO_DC::getPressureProjection(Real pressure, Real sig_eqv, Real cohesion)
{
...
void
RedbackMechMaterialDP_UO_DC::getFlowTensor(
 ...
 */
Real
RedbackMechMaterialDP_UO_DC::getFlowIncrement(
...
Real
RedbackMechMaterialDP_UO_DC::getDerivativeFlowIncrement(
...
void
RedbackMechMaterialDP_UO_DC::getJac(const RankTwoTensor & sig,
...
void
RedbackMechMaterialDP_UO_DC::get_py_qy(Real p, Real q, Real & p_y, Real & q_y, Real yield_stress)
{
