 ...
 */
void
RedbackMechMaterialJ2::getFlowTensorJ2(const RankTwoTensor & sig, Real yield_stress, RankTwoTensor & flow_tensor_dev)
{
...
Real
RedbackMechMaterialJ2::getFlowIncrementJ2(const RankTwoTensor & sig, Real yield_stress)
{
...
void
RedbackMechMaterialJ2::getJacJ2(const RankTwoTensor & sig, const RankFourTensor & E_ijkl, Real flow_incr_dev, Real yield_stress, RankFourTensor & dresid_dsig)
{
  unsigned i, j, k ,l;
...
void
RedbackMechMaterialJ2::get_py_qy_J2(Real p, Real q, Real & p_y, Real & q_y, Real yield_stress)
{
  p_y = p;
  q_y = yield_stress;
}
