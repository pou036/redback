...
template <>
InputParameters
validParams<RedbackMechMaterialJ2_UO>()
{
  InputParameters params = validParams<RedbackMechMaterial_UO>();
  return params;
}

RedbackMechMaterialJ2_UO::RedbackMechMaterialJ2_UO(const InputParameters & parameters) : RedbackMechMaterial_UO(parameters)
{
}
 ...
 */
void
RedbackMechMaterialJ2_UO::getFlowTensor(
...
Real
RedbackMechMaterialJ2_UO::getFlowIncrement(Real sig_eqv, Real p, Real q_y, Real p_y, Real yield_stress)
{
 ...
 */
Real
RedbackMechMaterialJ2_UO::getDerivativeFlowIncrement(const RankTwoTensor & sig, Real yield_stress)
{
...
void
RedbackMechMaterialJ2_UO::getJac(const RankTwoTensor & sig,
...
void
RedbackMechMaterialJ2_UO::get_py_qy(Real p, Real q, Real & p_y, Real & q_y, Real yield_stress)
{
  p_y = p;
  q_y = yield_stress;
}
