...
template <>
InputParameters
validParams<RedbackMechMaterialCCanisotropic_UO>()
{
  InputParameters params = validParams<RedbackMechMaterialCC_UO>();
  params.addParam<Real>("initial_anisotropy_param", 0, "Initial anisotropy coefficient (from Dafalias 2013)");

  return params;
}

RedbackMechMaterialCCanisotropic_UO::RedbackMechMaterialCCanisotropic_UO(const InputParameters & parameters) :
    RedbackMechMaterialCC_UO(parameters),
...
void
RedbackMechMaterialCCanisotropic_UO::stepInitQpProperties()
{
  RedbackMechMaterialCC_UO::stepInitQpProperties();
 ...
 */
void
RedbackMechMaterialCCanisotropic_UO::getFlowTensor(
 ...
 */
Real
RedbackMechMaterialCCanisotropic_UO::getFlowIncrement(
...
Real
RedbackMechMaterialCCanisotropic_UO::getDerivativeFlowIncrement(
...
void
RedbackMechMaterialCCanisotropic_UO::getJac(const RankTwoTensor & sig,
...
void
RedbackMechMaterialCCanisotropic_UO::get_py_qy(Real p, Real q, Real & p_y, Real & q_y, Real yield_stress)
{
