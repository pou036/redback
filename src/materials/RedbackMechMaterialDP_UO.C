...
template <>
InputParameters
validParams<RedbackMechMaterialDP_UO>()
{
...
RedbackMechMaterialDP_UO::RedbackMechMaterialDP_UO(const InputParameters & parameters) :
 ...
 */
Real
RedbackMechMaterialDP_UO::getPressureProjection(Real pressure, Real sig_eqv, Real cohesion)
{
...
void
RedbackMechMaterialDP_UO::getFlowTensor(
 ...
 */
Real
RedbackMechMaterialDP_UO::getFlowIncrement(
...
Real
RedbackMechMaterialDP_UO::getDerivativeFlowIncrement(
...
void
RedbackMechMaterialDP_UO::getJac(const RankTwoTensor & sig,
...
void
RedbackMechMaterialDP_UO::get_py_qy(Real p, Real q, Real & p_y, Real & q_y, Real yield_stress)
{
