...
validParams<RedbackMaterial_UO>()
{
  ...
  params.addParam<MooseEnum>("continuation_variable",
                             RedbackMaterial_UO::continuationMethodEnum() = "Gruntfest", // default value
  ...
  params.addParam<MooseEnum>(
    "density_method",
    RedbackMaterial_UO::densityMethodEnum() = "linear",
  ...
  params.addParam<MooseEnum>("permeability_method",
                             RedbackMaterial_UO::permeabilityMethodEnum() = "KozenyCarman",
...
RedbackMaterial_UO::RedbackMaterial_UO(const InputParameters & parameters) :
    Material(parameters),
...

{
	...
	_solid_thermal_expansion_uo = _common_redback_material_parameters->GetIfHasParameterObject("solid_thermal_expansion");
...
MooseEnum
RedbackMaterial_UO::continuationMethodEnum()
{
  return MooseEnum("Gruntfest Lewis");
}

MooseEnum
RedbackMaterial_UO::densityMethodEnum()
{
  return MooseEnum("linear");
}

MooseEnum
RedbackMaterial_UO::permeabilityMethodEnum()
{
  return MooseEnum("KozenyCarman");
}

void
RedbackMaterial_UO::stepInitQpProperties()
{
...
void
RedbackMaterial_UO::computeQpProperties()
{
  // Set our variables
...
void
RedbackMaterial_UO::computeRedbackTerms()
{
