...
RedbackMechMaterialDP::getDerivativeFlowIncrement(Real & dfi_dp,
                                                  ...
                                                  Real p_yield_stress)
{
  dfi_dp = _flow_law_uo.derivative_p(sig_eqv, pressure, q_yield_stress, p_yield_stress, sig, _qp, _dt);
  dfi_dq = _flow_law_uo.derivative_q(sig_eqv, pressure, q_yield_stress, p_yield_stress, sig, _qp, _dt);
