 ...
 */
Real
RedbackMechMaterialDP::getPressureProjection(Real pressure, Real sig_eqv,
                                                  Real cohesion) {
...
void
RedbackMechMaterialDP::getFlowTensor(const RankTwoTensor &sig, Real q,
 ...
 */
Real
RedbackMechMaterialDP::getFlowIncrement(Real sig_eqv, Real pressure,
                                             Real q_yield_stress,
                                             Real p_yield_stress,
                                             Real yield_stress) {
  Real flow_incr_vol =
...
RedbackMechMaterialDP::getJac(const RankTwoTensor &sig,
  ...
  dfi_dseqv = getDerivativeFlowIncrement(sig, pressure, sig_eqv, q_yield_stress,
                                         p_yield_stress);
...
void
RedbackMechMaterialDP::get_py_qy(Real p, Real q, Real &p_y, Real &q_y,
                                      Real yield_stress) {
