...
template <>
InputParameters
validParams<RedbackMechMaterialCCanisotropic_UO_DC>()
{
  InputParameters params = validParams<RedbackMechMaterialCC_UO_DC>();
  params.addParam<Real>("initial_anisotropy_param", 0, "Initial anisotropy coefficient (from Dafalias 2013)");

  return params;
}

RedbackMechMaterialCCanisotropic_UO_DC::RedbackMechMaterialCCanisotropic_UO_DC(const InputParameters & parameters) :
    RedbackMechMaterialCC_UO_DC(parameters),
...
void
RedbackMechMaterialCCanisotropic_UO_DC::stepInitQpProperties()
{
  RedbackMechMaterialCC_UO_DC::stepInitQpProperties();
 ...
 */
void
RedbackMechMaterialCCanisotropic_UO_DC::getFlowTensor(
 ...
 */
Real
RedbackMechMaterialCCanisotropic_UO_DC::getFlowIncrement(
...
Real
RedbackMechMaterialCCanisotropic_UO_DC::getDerivativeFlowIncrement(
...
void
RedbackMechMaterialCCanisotropic_UO_DC::getJac(const RankTwoTensor & sig,
...
void
RedbackMechMaterialCCanisotropic_UO_DC::get_py_qy(Real p, Real q, Real & p_y, Real & q_y, Real yield_stress)
{
