...
validParams<MaterialTensorSideIntegral>()
{
  ...
  params.addRequiredRangeCheckedParam<unsigned int>(
    "index_j", "index_j >= 0 & index_j <= 2", "The index j of ij for the tensor to output (0, 1, 2)");
  params.set<bool>("use_displaced_mesh") = true;
  return params;
}

MaterialTensorSideIntegral::MaterialTensorSideIntegral(const InputParameters & parameters) :
...
Real
MaterialTensorSideIntegral::computeQpIntegral()
{
