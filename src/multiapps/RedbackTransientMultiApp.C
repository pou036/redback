...
RedbackTransientMultiApp::RedbackTransientMultiApp(const InputParameters & parameters)
  : MultiApp(parameters),
...
RedbackTransientMultiApp::appTransferVector(unsigned int app, std::string var_name)
{
...
void
RedbackTransientMultiApp::initialSetup()
{
...
Real
RedbackTransientMultiApp::ReadFile(FileName file_name)
{
  Real value = 0;
  std::string line;
