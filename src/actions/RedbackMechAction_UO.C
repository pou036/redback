...
template <>
InputParameters
validParams<RedbackMechAction_UO>()
{
  ...
  //params.addParam<UserObjectName>("redback_material_parameters","redback_material_parameters_XXX","User object holding common redback material parameters");
...
RedbackMechAction_UO::RedbackMechAction_UO(InputParameters params) :
    Action(params),
    ...
    _rep_uo_name( getParam<UserObjectName>("redback_material_parameters") )
{
...
RedbackMechAction_UO::act()
{
  ...
  std::string type("RedbackStressDivergenceTensors_UO");
  ...
  params.set<UserObjectName>("redback_material_parameters") = _rep_uo_name; // getParam<UserObjectName>("redback_material_parameters");
