...
[BCs]
  active = 'bottom_fix_x bottom_fix_y bottom_fix_z top_fix_z corner_point_temp press_corner_point constant_y_velocity_top top_fix_x confinement_left confinement_right confinement_back confinment_front'
  [./temp_box]
    type = NeumannBC
    variable = temp
