...
[BCs]
  active = 'drained_top_bottom bottom_fix_x bottom_fix_y bottom_fix_z top_fix_x top_fix_z constant_y_velocity_top side_temp back_front_fix_z left_right_fix_x'
  [./temp_box]
    type = NeumannBC
    variable = temp
...
[Outputs]
  file_base = drained_oedometer_CC
  output_initial = true
  exodus = true
  checkpoint = true
  [./console]
