[Mesh]
  file = triaxial_compression_cp/0032_mesh.cpr
  distribution = serial
[]
...
[Executioner]
  ...
  reset_dt = true
  line_search = basic
  restart_file_base = triaxial_compression_cp/0032
  [./TimeStepper]
    type = ConstantDT
    dt = 1e-4
  [../]
...
[Outputs]
  file_base = triaxial_compression_restarted
  output_initial = true
  exodus = true
  checkpoint = true
  [./console]
