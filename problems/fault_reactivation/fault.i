...
[BCs]
  active = 'press_bc constant_force_inner_x low_temp left_disp rigth_disp_y left_disp_y constant_force_inner_y'
  [./left_disp]
    type = DirichletBC
    variable = disp_x
    boundary = 2
...
[Postprocessors]
  active = 'solid_ratio_middle strain_rate_middle middle_press Lewis_middle porosity_middle middle_temp mises_stress_centre'
  [./middle_temp]
    type = PointValue
    variable = temp
    point = '0.51 0 0.25'
